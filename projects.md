...
<h3>거래처 데이터베이스 구축 및 분석</h3>
<ul>
  <li>사내 거래처인 병원 데이터와 HIRA(건강보험심사평가원) 공공 데이터를 결합하여 데이터 분석 환경 구축.</li>
  <li>구축된 데이터를 바탕으로 거래처 그룹별 카이제곱 검정을 수행하여 핵심 영업 요인 및 고객 세분화 인사이트 도출.</li>
</ul>
...
<div class="project-card">
<h3>Loracle - 리그오브레전드 패치 예측 모델</h3>
<ul>
