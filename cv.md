...
<div style="text-align: center; margin-bottom: 40px; margin-top: 20px;">
  <h1 style="margin-bottom: 5px; font-size: 2.5em; font-weight: 600;">{{ site.author.name }}</h1>
  <h3 style="color: #666; margin-top: 0; font-weight: 400; letter-spacing: 1px;">{{ site.joblines[0] }}</h3>
  <p style="margin-top: 15px; font-size: 1.05em; color: #555; display: flex; justify-content: center; align-items: center; gap: 15px; flex-wrap: wrap;">
